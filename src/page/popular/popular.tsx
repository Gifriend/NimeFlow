      ...
      useEffect(() => {
        const fetchOngoingAnime = async () => {
          try {
            ...
            setPopularAnimeData(res.data.data.animeList);
      ...
      return (
        <div className="bg-gray-900 text-white min-h-screen">
          ...
          <main className="mr-80 mt-16 p-6">
            <div className="mb-8">
              <BackButton to="/home"/>
              <h2 className="text-2xl font-bold mb-2">Anime Terpopular</h2>
              <p className="text-gray-400">Daftar anime yang popular saat ini</p>
            </div>
