  ...
  return (
    <section className="mt-12">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-2xl font-semibold">Anime Terpopuler</h3>
        <Link to="/popular" className="text-sm text-purple-400 hover:underline">
              More
            </Link>
      </div>
      <div className="relative">
        ...
        >
          {popularList.slice(0, 15).map((anime) => (
            <Link
